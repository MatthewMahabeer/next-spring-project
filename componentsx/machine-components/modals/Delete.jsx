        ...
        <div className='modal'>
            <div className='modal-content-delete'>
                ...
                <div className='modal-header'>
                    {operator == "brand" ? "Are you sure you want to delete this brand?" : ''}
                </div>

                <div className='modal-content-paragraph'>
                    {operator == "brand" ? "All models and machines associated with this brand will be deleted along with it." : ""}
                </div>
